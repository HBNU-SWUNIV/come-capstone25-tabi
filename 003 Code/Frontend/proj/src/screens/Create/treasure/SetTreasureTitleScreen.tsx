...
export default function SetTitleScreen() {
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.contentWrapper}>
          <FloatingLabelInput
            label="보물찾기 제목"
            value={treasure.treasureHuntTitle}
            onChangeText={text =>
              setTreasure(prev => ({...prev, treasureHuntTitle: text}))
            }
          />
        </View>
        ...
        <View style={styles.footer}>
          <Pressable
            ...
            onPress={() => navigation.navigate('TreasureSetDescription')}>
            {({pressed}) => (
              <Text
                style={[
